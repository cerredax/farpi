...
npm run test:unit      # 563 tests de lógica pura (~2 s, sin servidor)
npm run test:e2e       # suite completa: 740 (563 unitarios + 177 de navegador; levanta dev en :3100 en modo demo forzado)
