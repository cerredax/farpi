...
export const db: DB = {
  ...
  kids: [
    { id: '1', family_id: 'f1', name: 'Ana', birth_date: '2026-06-03', color: '#C05F45', kind: 'hijo', created_at: '2026-06-03T11:42:00' },
  ],

  events: [
    { id: 'e01', family_id: 'f1', child_id: '1', member_id: null,  title: 'Alta hospitalaria Ana',         description: 'Guardar informe y cartilla',       start_at: '2026-06-05T11:30:00', end_at: null, all_day: false, kind: 'evento' as const, color: null,      recurrence_group_id: null, created_by: 'u1', created_at: '2026-06-04T18:00:00', updated_at: '2026-06-04T18:00:00' },
    { id: 'e02', family_id: 'f1', child_id: null, member_id: null, title: 'Registro civil',                description: 'Inscripción de nacimiento',        start_at: '2026-06-08T09:15:00', end_at: null, all_day: false, kind: 'evento' as const, color: '#E9C46A', recurrence_group_id: null, created_by: 'u1', created_at: '2026-06-05T13:00:00', updated_at: '2026-06-05T13:00:00' },
    { id: 'e03', family_id: 'f1', child_id: '1', member_id: null,  title: 'Matrona: revisión Sofía y Ana', description: 'Centro de salud, consulta 4',     start_at: '2026-06-10T12:00:00', end_at: null, all_day: false, kind: 'evento' as const, color: null,      recurrence_group_id: null, created_by: 'u2', created_at: '2026-06-07T09:00:00', updated_at: '2026-06-07T09:00:00' },
    { id: 'e04', family_id: 'f1', child_id: '1', member_id: null,  title: 'Pediatra 14 días',              description: 'Peso, ombligo y dudas de sueño',   start_at: '2026-06-17T10:30:00', end_at: null, all_day: false, kind: 'evento' as const, color: null,      recurrence_group_id: null, created_by: 'u1', created_at: '2026-06-12T20:00:00', updated_at: '2026-06-12T20:00:00' },
    { id: 'e05', family_id: 'f1', child_id: null, member_id: null, title: 'Farmacia de guardia',           description: 'Recoger vitamina D',               start_at: '2026-06-17T18:30:00', end_at: null, all_day: false, kind: 'evento' as const, color: '#8BA888', recurrence_group_id: null, created_by: 'u1', created_at: '2026-06-16T21:00:00', updated_at: '2026-06-16T21:00:00' },
    { id: 'e06', family_id: 'f1', child_id: null, member_id: null, title: 'Abuelos vienen a merendar',     description: 'Visita corta, traer bizcocho',     start_at: '2026-06-19T17:30:00', end_at: null, all_day: false, kind: 'evento' as const, color: '#D8A48F', recurrence_group_id: null, created_by: 'u2', created_at: '2026-06-15T11:00:00', updated_at: '2026-06-15T11:00:00' },
    { id: 'e07', family_id: 'f1', child_id: '1', member_id: null,  title: 'Paseo temprano con Ana',        description: 'Evitar horas de calor',            start_at: '2026-06-20T09:30:00', end_at: null, all_day: false, kind: 'evento' as const, color: null,      recurrence_group_id: null, created_by: 'u1', created_at: '2026-06-16T08:30:00', updated_at: '2026-06-16T08:30:00' },
    { id: 'e08', family_id: 'f1', child_id: null, member_id: null, title: 'Compra grande online',          description: 'Pañales, toallitas y comida casa', start_at: '2026-06-21T11:00:00', end_at: null, all_day: false, kind: 'evento' as const, color: '#E9C46A', recurrence_group_id: null, created_by: 'u1', created_at: '2026-06-16T19:00:00', updated_at: '2026-06-16T19:00:00' },
    { id: 'e09', family_id: 'f1', child_id: '1', member_id: null,  title: 'Revisión lactancia',            description: 'Llevar muselina y cartilla',       start_at: '2026-06-23T11:45:00', end_at: null, all_day: false, kind: 'evento' as const, color: null,      recurrence_group_id: null, created_by: 'u2', created_at: '2026-06-17T08:00:00', updated_at: '2026-06-17T08:00:00' },
    { id: 'e10', family_id: 'f1', child_id: null, member_id: null, title: 'Pedir cita tarjeta sanitaria',  description: 'Trámite pendiente de Ana',         start_at: '2026-06-25T09:00:00', end_at: null, all_day: false, kind: 'evento' as const, color: '#8BA888', recurrence_group_id: null, created_by: 'u1', created_at: '2026-06-17T08:05:00', updated_at: '2026-06-17T08:05:00' },
    { id: 'e11', family_id: 'f1', child_id: '1', member_id: null,  title: 'Control peso Ana',              description: 'Consulta de enfermería pediátrica', start_at: '2026-06-30T10:15:00', end_at: null, all_day: false, kind: 'evento' as const, color: null,      recurrence_group_id: null, created_by: 'u1', created_at: '2026-06-17T08:10:00', updated_at: '2026-06-17T08:10:00' },
    { id: 'e12', family_id: 'f1', child_id: null, member_id: null, title: 'Cumplemes de Ana',              description: 'Primer mes en casa',               start_at: '2026-07-03T00:00:00', end_at: null, all_day: true, kind: 'evento' as const,  color: '#D8A48F', recurrence_group_id: null, created_by: 'u2', created_at: '2026-06-17T08:15:00', updated_at: '2026-06-17T08:15:00' },
  ],
  ...
  documents: [
    { id: 'd1', family_id: 'f1', child_id: '1', member_id: null,  name: 'Informe alta hospitalaria Ana', description: 'Nacimiento y alta de maternidad', category: 'salud',    storage_path: 'mock/alta-hospitalaria-ana.pdf', mime_type: 'application/pdf', size_bytes: 358400, expires_on: null, created_by: 'u1', created_at: '2026-06-05T13:00:00', updated_at: '2026-06-05T13:00:00' },
    { id: 'd2', family_id: 'f1', child_id: '1', member_id: null,  name: 'Cartilla de salud Ana',         description: 'Revisiones y vacunas',            category: 'salud',    storage_path: 'mock/cartilla-salud-ana.pdf',    mime_type: 'application/pdf', size_bytes: 245760, expires_on: null, created_by: 'u2', created_at: '2026-06-05T13:30:00', updated_at: '2026-06-05T13:30:00' },
    { id: 'd3', family_id: 'f1', child_id: '1', member_id: null,  name: 'Certificado nacimiento Ana',    description: 'Copia para trámites',             category: 'personal', storage_path: 'mock/certificado-ana.pdf',       mime_type: 'application/pdf', size_bytes: 286720, expires_on: null, created_by: 'u1', created_at: '2026-06-10T18:00:00', updated_at: '2026-06-10T18:00:00' },
    { id: 'd4', family_id: 'f1', child_id: null, member_id: null, name: 'Libro de familia',              description: null,                              category: 'personal', storage_path: 'mock/libro-familia.pdf',         mime_type: 'application/pdf', size_bytes: 512000, expires_on: null, created_by: 'u1', created_at: '2026-06-11T10:00:00', updated_at: '2026-06-11T10:00:00' },
    { id: 'd5', family_id: 'f1', child_id: null, member_id: null, name: 'DNI Omar',                      description: 'Documento de Omar',               category: 'personal', storage_path: 'mock/dni-omar.jpg',              mime_type: 'image/jpeg',      size_bytes: 132096, expires_on: '2026-08-20', created_by: 'u1', created_at: '2026-06-01T00:00:00', updated_at: '2026-06-01T00:00:00' },
  ],
}
