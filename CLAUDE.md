...
npm run test:unit      # 430 tests de lógica pura (~2 s, sin servidor)
npm run test:e2e       # suite completa: 562 (430 unitarios + 132 de navegador; levanta dev en :3100 en modo demo forzado)
