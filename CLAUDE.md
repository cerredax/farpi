...
npm run test:unit      # 445 tests de lógica pura (~2 s, sin servidor)
npm run test:e2e       # suite completa: 581 (445 unitarios + 136 de navegador; levanta dev en :3100 en modo demo forzado)
