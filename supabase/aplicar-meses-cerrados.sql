-- ============================================================================
-- Farpi · Los meses cerrados (02-09-2026, reescrito el 03-09-2026)
-- ============================================================================
--
...
-- en las tablas nuevas: no toca `fixed_entries`, `budgets` ni `expenses`.
--
-- Lleva ya el cierre que **no inventa meses** y `empty_month` (03-09-2026): la
-- regla del archivo es reescribirlo entero, así que esto es siempre lo último que
-- vale, no el delta del día que se creó.
-- ============================================================================
...
-- plantilla de hoy todos los meses terminados que tengan algún apunte. Desde el
-- 03-09-2026 ya no puede escribir números inventados: `close_month_copy` solo
-- copia lo que existía antes de que el mes acabara, así que un mes anterior a la
-- plantilla se queda sin cerrar en vez de cerrarse con la foto de hoy.
--
