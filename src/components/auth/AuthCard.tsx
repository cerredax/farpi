...
/**
 * Entrar y crear cuenta: las dos pestañas, Google si está activo, los campos y
 * recuperar contraseña.
 *
 * Vivía dentro de `LoginForm` hasta el 01-09-2026, mezclado con la maqueta de
 * la pantalla de login. Salió de ahí cuando la **portada pública** pasó a
 * enseñar el formulario de verdad en vez de un botón que llevaba a él: quien
 * llega a Farpi puede entrar sin cambiar de página. Copiarlo habría sido peor
 * que moverlo —dos formularios de autenticación divergen en cuanto alguien
 * toca un mensaje de error—, así que hay uno solo y lo montan los dos sitios:
 * `/auth/login` (donde aterrizan las invitaciones y los correos de
