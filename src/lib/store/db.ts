...
export const db: DB = {
  families: [
    { id: 'f1', name: 'Familia de Omar, Sofía y Cris', meal_slots: [...ALL_MEAL_SLOTS], created_at: '2026-06-01T00:00:00', updated_at: '2026-06-17T08:00:00' },
  ],
  ...
  lists: [
    ...
    { id: 'l4', family_id: 'f1', name: 'Papeleo',         emoji: '📋', color: null, created_by: 'u1', created_at: '2026-06-08T00:00:00', updated_at: '2026-06-17T08:00:00' },
  ...
  listItems: [
    ...
    { id: 'li8',  list_id: 'l3', family_id: 'f1', text: 'Bajar la ropa del tendedero',  quantity: 1, completed: false, completed_at: null,                  completed_by: null, sort_order: 0, created_by: 'u2', created_at: '2026-06-16T00:00:00' },
    { id: 'li9',  list_id: 'l3', family_id: 'f1', text: 'Ordenar el trastero',          quantity: 1, completed: false, completed_at: null,                  completed_by: null, sort_order: 1, created_by: 'u1', created_at: '2026-06-16T00:00:00' },
    { id: 'li10', list_id: 'l3', family_id: 'f1', text: 'Sacar la basura',              quantity: 1, completed: true,  completed_at: '2026-06-17T07:30:00', completed_by: 'u1', sort_order: 2, created_by: 'u1', created_at: '2026-06-17T00:00:00' },
    { id: 'li11', list_id: 'l4', family_id: 'f1', text: 'Escanear el seguro del coche', quantity: 1, completed: false, completed_at: null,                  completed_by: null, sort_order: 0, created_by: 'u1', created_at: '2026-06-17T00:00:00' },
    { id: 'li12', list_id: 'l4', family_id: 'f1', text: 'Renovar el DNI',               quantity: 1, completed: false, completed_at: null,                  completed_by: null, sort_order: 1, created_by: 'u1', created_at: '2026-06-17T00:00:00' },
    { id: 'li13', list_id: 'l4', family_id: 'f1', text: 'Guardar la factura de la caldera', quantity: 1, completed: true, completed_at: '2026-06-10T18:00:00', completed_by: 'u2', sort_order: 2, created_by: 'u2', created_at: '2026-06-09T00:00:00' },
  ...
  documents: [
    ...
    { id: 'd3', family_id: 'f1', child_id: null, member_id: null, name: 'Seguro del coche',              description: 'Póliza y recibo'    ,             category: 'personal', storage_path: 'mock/seguro-coche.pdf', storage_provider: 'google_drive', storage_owner: 'u1',       mime_type: 'application/pdf', size_bytes: 286720, expires_on: null, created_by: 'u1', created_at: '2026-06-10T18:00:00', updated_at: '2026-06-10T18:00:00' },
