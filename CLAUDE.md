...
npm run test:unit      # 345 tests de lógica pura (~2 s, sin servidor)
npm run test:e2e       # suite completa: 456 (345 unitarios + 111 de navegador; levanta dev en :3100 en modo demo forzado)
