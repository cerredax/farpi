...
- **578 tests con el runner de Playwright**, sin dependencias nuevas. Este es el
  **único** sitio con el recuento exacto: el resto de documentos habla de "los
  ...
  - 151 de navegador. La cifra sale de la pasada completa del 08-09-2026 (635 en total,
    484 unitarios; las dos últimas, de la auditoría de Listas, Tareas y Notas: que buscar
