...
npm run test:unit      # 388 tests de lógica pura (~2 s, sin servidor)
npm run test:e2e       # suite completa: 514 (388 unitarios + 126 de navegador; levanta dev en :3100 en modo demo forzado)
