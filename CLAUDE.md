...
npm run test:unit      # 512 tests de lógica pura (~2 s, sin servidor)
npm run test:e2e       # suite completa: 681 (512 unitarios + 169 de navegador; levanta dev en :3100 en modo demo forzado)
