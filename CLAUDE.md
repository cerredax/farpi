...
npm run test:unit      # 590 tests de lógica pura (~2 s, sin servidor)
npm run test:e2e       # suite completa: 769 (590 unitarios + 179 de navegador; levanta dev en :3100 en modo demo forzado)
