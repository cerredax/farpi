...
npm run test:unit      # 424 tests de lógica pura (~2 s, sin servidor)
npm run test:e2e       # suite completa: 554 (424 unitarios + 130 de navegador; levanta dev en :3100 en modo demo forzado)
