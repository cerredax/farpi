...
Resultados en **`docs/supabase-validation.md`**: 51/51 comprobaciones correctas, con las 18 migraciones validadas (última pasada, 21-08-2026). Repetible con `node scripts/validate-rls.mjs`.
