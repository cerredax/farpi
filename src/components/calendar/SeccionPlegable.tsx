 ...
 *
 * El número va en el título **cuando cuenta algo que hay que preparar**: plegado
 * es lo único que se ve, y sin él la línea no distingue "queda uno" de "quedan
 * cinco". Cuando no hay nada, el bloque no se pinta (eso lo decide cada uno, que
 * sabe qué contar).
 *
 * Es opcional desde el 14-09-2026, y quien lo estrena apagándolo es "Vacaciones y
 * descansos": ahí el número no es una cantidad que se prepare, es cuántos
 * apuntes hay dentro. Tres turnos sueltos de la misma persona contaban tres y la
 * respuesta seguía siendo "falta Carlos". Cumpleaños sí lo lleva, porque cinco
 * cumpleaños son cinco personas a las que felicitar.
 *
...
interface SeccionPlegableProps {
   ...
   * Sin él no se pinta la pastilla: hay bloques donde el número no contesta
   * nada (ver arriba).
   */
  cuantos?: number
  children: ReactNode
