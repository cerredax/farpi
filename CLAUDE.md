...
npm run test:unit      # 592 tests de lógica pura (~2 s, sin servidor)
npm run test:e2e       # suite completa: 774 (592 unitarios + 182 de navegador; levanta dev en :3100 en modo demo forzado)
