  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-line safe-area-pb lg:hidden">
      <div className="flex items-center justify-around h-16 max-w-lg mx-auto px-2">
        ...
        {/* La sexta: Finanzas, Notas, Cumpleaños, Documentos, Ajustes y cerrar
            sesión. No se marca activa en ninguna de esas rutas —no es una
            pantalla, es por dónde se llega— y marcarla haría creer que la barra
