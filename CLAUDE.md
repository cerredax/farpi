...
npm run test:unit      # 393 tests de lógica pura (~2 s, sin servidor)
npm run test:e2e       # suite completa: 520 (393 unitarios + 127 de navegador; levanta dev en :3100 en modo demo forzado)
