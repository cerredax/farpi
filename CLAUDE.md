...
npm run test:unit      # 444 tests de lógica pura (~2 s, sin servidor)
npm run test:e2e       # suite completa: 578 (444 unitarios + 134 de navegador; levanta dev en :3100 en modo demo forzado)
