...
npm run test:unit      # 660 tests de lógica pura (~2 s, sin servidor)
npm run test:e2e       # suite completa: 858 (660 unitarios + 198 de navegador; levanta dev en :3100 en modo demo forzado)
