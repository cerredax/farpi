      ...
      <div className="flex items-center justify-between h-14 max-w-lg mx-auto px-4">
        {isHome ? (
          <div className="flex flex-col">
            <span className="text-primary font-extrabold tracking-tight text-lg leading-tight">Nido</span>
            <span className="text-[10px] font-semibold text-muted leading-none">{family.name}</span>
          </div>
        ) : (
