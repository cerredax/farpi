...
npm run test:unit      # 398 tests de lógica pura (~2 s, sin servidor)
npm run test:e2e       # suite completa: 526 (398 unitarios + 128 de navegador; levanta dev en :3100 en modo demo forzado)
